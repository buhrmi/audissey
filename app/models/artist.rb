...
# Use Case: Buy 4 artists for 5 USD
# 1. Create price (4 for 5 USD)
# 2. Create purchase using that price
# 3. Through purchase, give user 4 credits for this artist
# 4. Use credits to create booking
# 5. Both parties (booker and artist creator) need to confirm booking (contract signing). Can change time.
